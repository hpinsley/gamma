...
const WorkflowDisplay: React.FC<WorkflowDisplayProps> = ({ isDefault, workflow, setAsDefault, onEdit, onCopy }) => {
  ...
  return (
    <div className="workflow-container">
      <h1>
        ...
        <button className='workflow-copy-btn' onClick={() => onCopy(workflow)}>Copy</button>
      </h1>
      <table>
        <tbody>
